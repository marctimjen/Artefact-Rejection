# this script is for running the multi class of sgd on the best accuarcy
...
x = torch.load(f"C:/Users/Marc/Desktop/SGD elec epoch 18/network_SGD-acc-epk-18.pt", map_location='cpu')
...
val_files_test(ind=ind,
               input_path=r"C:\Users\Marc\Desktop\test_sgd_epoch18",
