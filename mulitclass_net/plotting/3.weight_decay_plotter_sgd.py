...
ax1.set_title(f'SGD optimizer with weight_decay of {sgd1_weight}')
...
ax2.set_title(f'SGD optimizer with weight_decay of {sgd2_weight}')
...
ax3.set_title(f'SGD optimizer with weight_decay of {sgd3_weight}')
